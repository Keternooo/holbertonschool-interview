...
/**
 * check_grids - check if the sandpiles is stable
 * @grid1: sandpiles to check
 * Return: 0 if error 1 if stable
 */
...
/**
 * change_grids - add the sum of two sandpiles
 * @grid1: var for the sandpiles stable
